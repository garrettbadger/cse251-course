...
class Factory(threading.Thread):
    ...
    def __init__(self, queue, cars_in_queue, cars_not_in_queue, queu_stats):
...
def main():
    ...
    fac = threading.Thread(target=Factory, args=(cars_queue, cars_in_queue, cars_not_in_queue, queue_stats))
